...
export default function ScheduleEdit() {
  return (
    <main className="schedule-edit-container">
      ...
      <CardContainer title="Asignaturas" dataType="subjects">
        {subjects.map((subject) => (
          <Card key={subject.code} name={subject.name} code={subject.code} />
        ))}
      </CardContainer>
      <CardContainer title="Docentes" dataType="teachers">
      ...
      <CardContainer title="Laboratorios" dataType="laboratories">
